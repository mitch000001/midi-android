...
import org.mitchwork.midi.databinding.FragmentMidiDeviceDetailSysexBinding
...
class MidiDeviceDetailSysExFragment : Fragment() {

    private lateinit var viewModel: MidiDeviceDetailViewModel
    private lateinit var viewBinding: FragmentMidiDeviceDetailSysexBinding

    override fun onCreateView(
        inflater: LayoutInflater, container: ViewGroup?,
        savedInstanceState: Bundle?
    ): View? {
        viewBinding = FragmentMidiDeviceDetailSysexBinding.inflate(inflater, container, false)
